          ...
          return (
            <>
              <View style={styles.card}>
                <ImageBackground style={styles.cardImage} source={{ uri: i?.userFrom?.image1.length > 0 ? i?.userFrom?.image1 : 'https://res.cloudinary.com/ddu4sybue/image/upload/v1677572160/Group_6_ijye6n.png' }} >
